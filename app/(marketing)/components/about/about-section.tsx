          ...
          <div className="absolute bottom-0 left-0 right-0 p-6 md:p-8 flex flex-col md:flex-row gap-4 md:gap-6 justify-center">
            <div className="bg-white rounded-lg p-6 md:p-8 flex-1 max-w-sm shadow-lg">
              ...
              <p className="text-sm md:text-base text-gray-700">
                Total Properties Sold, Helping Families Find Their Dream Homes
                For Over A Decade.
              </p>
            </div>
            <div className="bg-white rounded-lg p-6 md:p-8 flex-1 max-w-sm shadow-lg">
              ...
              <p className="text-sm md:text-base text-gray-700">
                Strong Partnerships With Local Businesses To Enhance Our
                Services.
              </p>
            </div>
            <div className="bg-white rounded-lg p-6 md:p-8 flex-1 max-w-sm shadow-lg">
              ...
              <p className="text-sm md:text-base text-gray-700">
                Client Satisfaction Rate, Reflecting Our Commitment To
                Exceptional Service.
              </p>
            </div>
          </div>
